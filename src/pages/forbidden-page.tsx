  ...
  return (
    <div className="grid min-h-dvh place-items-center p-6 text-center bg-background relative overflow-hidden">
      ...
      <div className="max-w-md space-y-8 z-10">
        ...
        <div className="pt-4">
          <FuzzyText baseIntensity={0.2} hoverIntensity={0.5} enableHover className="text-8xl font-black tracking-tight text-destructive sm:text-9xl drop-shadow-md">
            403
          </FuzzyText>
        </div>
        ...
        <Link to="/dashboard" className="inline-block mt-4">
          <Button size="lg" variant="destructive" className="rounded-full px-8 shadow-lg shadow-destructive/20 hover:scale-105 transition-transform">
            {t('error.goBack')}
          </Button>
        </Link>
      </div>
